...
- Variants always require a discriminator and named alternatives (used for tagging); introspection-enabled (`enableIntrospect = true`) additionally requires names on objects, enums, variants, and custom types.
